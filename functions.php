...
if ( ! function_exists( 'louis_setup' ) ) :
	...
	function louis_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'louis' ),
		) );
 ...
 */
function louis_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'louis_content_width', 640 );
}
add_action( 'after_setup_theme', 'louis_content_width', 0 );
...
function louis_widgets_init() {
	register_sidebar( array(
		...
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'louis' ),
...
function louis_scripts() {
	...
	wp_enqueue_script( 'louis-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'louis-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
